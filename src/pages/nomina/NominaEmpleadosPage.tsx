...
export function NominaEmpleadosPage() {
  ...
  const handleSave = async () => {
    ...
    const payload = { ...formData, dailyRate: formData.dailyRate > 0 ? formData.dailyRate : undefined, taskRate: formData.taskRate > 0 ? formData.taskRate : undefined, unitRate: formData.unitRate > 0 ? formData.unitRate : undefined, notas: formData.notas?.trim() ? formData.notas : undefined }
    try {
